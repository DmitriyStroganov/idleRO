/**
 * Mirror of the server's `OutMessage`/`InMessage` protocol types.
 *
 * Kept in sync manually with idleRO-server/src/ws/protocol.ts. Both sides
 * are TypeScript — we accept the duplication to keep the two repos
 * independent.
 */
